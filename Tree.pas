...
begin
value:=3;
//Проверка по вертикали и присваивание соответствующей оценки
...
//Проверка по горизонтали и присваивание соответствующей оценки
for I := 0 to 2 do
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   begin
   value:=3;
   //Проверка по 1 диагонали и присваивание соответствующей оценки
...
var value :integer;
   begin
   value:=3;
   //Проверка по 2 диагонали и присваивание соответствующей оценки
...
//Сравниваем значения по вертикали горизонтали и диагоналям и выбираем большее
...
max:=0;
  ...
  //Выбор наибольшей оценки и состояния
  for I := 0 to Root^.CountChild-1 do
   ...
   //Если состояние игры проигрышное, то ищем состояние ничьей
      if Root^.Key=1 then
        begin
          for I := 0 to Root^.CountChild-1 do
